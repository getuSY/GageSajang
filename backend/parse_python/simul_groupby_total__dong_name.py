...
df['총_생활인구_수'] = df['총_생활인구_수'].fillna(df['분기당_매출_금액'].mean())
df['총_생활인구_수'] = df['총_생활인구_수'].replace(np.inf, df['분기당_매출_금액'].mean())
df['남성_생활인구_수'] = df['남성_생활인구_수'].fillna(df['분기당_매출_금액'].mean())
df['남성_생활인구_수'] = df['남성_생활인구_수'].replace(np.inf, df['분기당_매출_금액'].mean())
df['여성_생활인구_수'] = df['여성_생활인구_수'].fillna(df['분기당_매출_금액'].mean())
df['여성_생활인구_수'] = df['여성_생활인구_수'].replace(np.inf, df['분기당_매출_금액'].mean())
...
df = df.astype({'분기당_매출_금액':'int64', '분기당_매출_건수':'int64', '점포수':'int64', '유사_업종_점포_수':'int64', '개업_점포_수':'int64', '폐업_점포_수':'int64', '프랜차이즈_점포_수':'int64', '총_생활인구_수':'int64',  '남성_생활인구_수':'int64',  '여성_생활인구_수':'int64', '월_평균_소득_금액':'int64', '소득_구간_코드':'int64', '지출_총금액':'int64', '총 상주인구 수':'int64', '총_직장_인구_수':'int64', '남성_직장_인구_수':'int64', '여성_직장_인구_수':'int64', '아파트_평균_시가':'int64', '집객시설_수':'int64'})
