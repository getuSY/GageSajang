...
df1 = pd.read_excel(r'C:\Users\SSAFY\Desktop\E205\tmp\S07P31E205\backend\parse_python\data\소득소비.xlsx')
df1
len(df1)

df2 = pd.read_excel(r'C:\Users\SSAFY\Desktop\E205\tmp\S07P31E205\backend\parse_python\data\상주인구.xlsx')

print(df1.iloc[0])
print(df2.iloc[0])
df1.rename(columns = {'기준 년 코드':'기준_년_코드'},inplace=True)
