...
df1 = pd.read_excel(r'C:\Users\SSAFY\Desktop\E205\tmp\S07P31E205\backend\parse_python\data\소득_상주_직장.xlsx')
df1
len(df1)

df2 = pd.read_excel(r'C:\Users\SSAFY\Desktop\E205\tmp\S07P31E205\backend\parse_python\data\아파트_집객시설.xlsx')
...
len(total_df)
total_df.to_excel("최종_single_data.xlsx")
