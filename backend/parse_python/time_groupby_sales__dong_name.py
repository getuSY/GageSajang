...
df_sales = pd.read_excel(r'C:\Users\SSAFY\Desktop\E205\S07P31E205\backend\parse_python\time_dong\time_dong_2021.xlsx')
df_sales
...
df['총비율'] = df['시간대_00~06_매출_비율'] +  df['시간대_06~11_매출_비율'] +  df['시간대_11~14_매출_비율'] +  df['시간대_14~17_매출_비율'] +  df['시간대_17~21_매출_비율'] +  df['시간대_21~24_매출_비율']

df['시간대_00~06_매출_비율'] = df['시간대_00~06_매출_비율'] / df['총비율'] * 100
df['시간대_06~11_매출_비율'] = df['시간대_06~11_매출_비율'] / df['총비율'] * 100
df['시간대_11~14_매출_비율'] = df['시간대_11~14_매출_비율'] / df['총비율'] * 100
df['시간대_14~17_매출_비율'] = df['시간대_14~17_매출_비율'] / df['총비율'] * 100
df['시간대_17~21_매출_비율'] = df['시간대_17~21_매출_비율'] / df['총비율'] * 100
df['시간대_21~24_매출_비율'] = df['시간대_21~24_매출_비율'] / df['총비율'] * 100
...
df.to_excel("sales_time_dong_2021.xlsx")
