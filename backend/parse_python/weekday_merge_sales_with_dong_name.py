...
df_sales = pd.read_excel(r'C:\Users\SSAFY\Desktop\E205\S07P31E205\backend\parse_python\sales_weekday\sales_2021.xlsx')
df_sales
...
len(total_sales)
total_sales.to_excel("weekday_dong_2021.xlsx")
