...
public class StoreHinLivingPopulation {
    ...
    public void getApi(){
        StringBuilder urlBuilder = new StringBuilder("http://openapi.seoul.go.kr:8088/" + apiKey + "/json/VwsmTrdhlFlpopQq");
        try {
        ...
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\SSAFY\\Documents\\GitHub\\S07P31E205\\backend\\parse\\src\\main\\resources\\csv\\hinterland\\LivingPopulationStoreHin.csv"));
    ...
    public int parser(String json){
        ...
        try{
            ...
            JSONObject VwsmTrdarFlpopQq = (JSONObject)jsonObject.get("VwsmTrdhlFlpopQq");
