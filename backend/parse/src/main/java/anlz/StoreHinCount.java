...
public class StoreHinCount {

    public static List<String[]> readCSV(int year){
        List<String[]> list = new ArrayList<>();

        File csvFile = new File("C:\\Users\\SSAFY\\Documents\\GitHub\\S07P31E205\\backend\\parse\\src\\main\\resources\\csv\\StoreRareData\\StoreHinCount" + String.valueOf(year) + ".csv");
    ...
    public void combine(){
        ...
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\SSAFY\\Documents\\GitHub\\S07P31E205\\backend\\parse\\src\\main\\resources\\csv\\hinterland\\StoreHinCount.csv", StandardCharsets.UTF_8));
