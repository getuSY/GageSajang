...
public class StoreGuCS {
    ...
    public static List<String[]> readCSV(){
        ...
        try {
            ...
            while((line = br.readLine())!=null){
                ...
                list.add(new String[]{lineArr[0], lineArr[1], lineArr[4], lineArr[5], lineArr[6], lineArr[7]});
            }
        } catch (IOException e) {
    ...
    public void sum(){
        ...
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\SSAFY\\Documents\\GitHub\\S07P31E205\\backend\\parse\\src\\main\\resources\\csv\\ResultStoreGuCS.csv", StandardCharsets.UTF_8));
