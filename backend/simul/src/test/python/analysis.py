...
# df.drop(['_id', '시군구명', '읍면동명', '서비스_업종_코드', '서비스_업종_코드_명', '점포수', '총_생활인구_수', '소득_구간_코드', '총_직장_인구_수' ], axis = 1, inplace=True)
df.drop(['_id', '시군구명', '읍면동명', '서비스_업종_코드', '서비스_업종_코드_명', '유사_업종_점포_수', '개업_점포_수', '폐업_점포_수', '남성_생활인구_수', '여성_생활인구_수', '남성_직장_인구_수', '여성_직장_인구_수', '월_평균_소득_금액' ], axis = 1, inplace=True)
